    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, padding: '20px' }}>
        ...
        <p><strong>Verwendung von Logos</strong><br />
          Die auf dieser Website verwendeten Logos der Teams und des Ligaorganisators/Verbandes werden mit Genehmigung der jeweiligen Rechteinhaber genutzt. Einige Genehmigungen für die Verwendung dieser Logos stehen derzeit noch aus. Wir haben entsprechende Anfragen an die betreffenden Rechteinhaber gestellt und erwarten deren Zustimmung. Sollte es zu Unklarheiten oder rechtlichen Bedenken kommen, bitten wir um eine Kontaktaufnahme per E-Mail. Bei Bekanntwerden etwaiger Rechtsverletzungen werden wir die entsprechenden Logos unverzüglich entfernen.</p>
