...
const Teams = () => {
      ...
      try {
        ...
        if (data && data.length > 0) {
          ...
          filteredData.forEach(row => {
            if (row[1]) divisionsSet.add(row[1]);
          });
  ...
  const applyFilters = (data) => {
    return data.filter(row => {
      const divisionMatch = filters.division === 'All' || row[1] === filters.division;
          ...
          <div className="filters">
            ...
            <label>
              ...
              >
                ...
                {headers.slice(2).map((header, idx) => (
        ...
        <div className="teams-container">
          ...
          <div className="table-wrapper">
            <table className="table-container">
              <thead>
                <tr>
                  <th className="team-row-number-column">#</th> {/* Zeilennummer-Header */}
              ...
              <tbody>
                {displayedTeams.map((row, idx) => (
                  <tr key={idx}>
                    <td className="team-row-number-column">{(currentPage - 1) * rowsPerPage + idx + 1}</td> {/* Zeilennummer */}
