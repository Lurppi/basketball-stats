    ...
    <div className="home-container">
      ...
      <div className="content">
        <div className="text-container">
          <p>Here are the current top 10 players and teams in various categories, like Points per Game, Rebounds per Game or Assists per Game. Players with 100+ total minutes are qualified for the ranking.</p>
