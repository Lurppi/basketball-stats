    ...
    <div className="home-container">
      ...
      <div className="content">
        <div className="text-container">
          <p>Here are the current top 10 players and teams in various categories, like Points per Game, Rebounds per Game or Assists per Game. Players with 20+ total minutes are qualified for the ranking. Choose between NBBL or JBBL and Players or Teams. </p>
          <h1>PLAYOFFS Top 10 Leaders</h1>
        </div>
