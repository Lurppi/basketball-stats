...
const assignBadges = (seasonData) => {
  ...
  // Sharpshooter Badge
  if (parseFloat(seasonData['3P%']) > 35.0 && parseFloat(seasonData['3PAPG']) >= 4 && parseFloat(seasonData['3PA']) >= 20) {
  ...
  // Rim Protector Badge
  if (parseFloat(seasonData['BPG']) >= 1.5 && parseFloat(seasonData['BS%']) >= 3.5 && parseFloat(seasonData['DRTG_ADJ']) < 95) {
  ...
  if (parseFloat(seasonData['EFG%']) > 55 && parseFloat(seasonData['TS%']) > 60 && parseFloat(seasonData['FGA']) >= 20 && parseFloat(seasonData['3PA']) >= 10 && parseFloat(seasonData['3PAPG']) >= 2.5) {
